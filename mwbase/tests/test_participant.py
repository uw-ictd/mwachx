...
from mwbase.models import Participant
# Local Imports
...
class ParticipantBasicTests(test.TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_utils.setup_basic_participants(cls)
    ...
    def test_send_batch(self):
        ...
        self.assertEqual(new_message.participant, self.p2)
...
class ParticipantSerializerTests(rf_test.APITestCase):
    ...
    def test_participant_detail(self):
        ...
        self.assertEqual(response.data['sms_name'], 'P1 one')
    ...
    def test_create(self):
        ...
        data = {"previous_pregnancies": 0, "study_id": "0004", "anc_num": "0004", "study_group": "two-way",
                "language": "english", "phone_number": "0700000004", "sms_name": "Test", "birthdate": "1990-02-05",
        ...
        try:
            new_participant = Participant.objects.get(study_id="0004")
        ...
        self.assertEqual(new_participant.sms_name, 'Test')
    ...
    def test_create_control(self):
        ...
        data = {"previous_pregnancies": 0, "study_id": "0004", "anc_num": "0004", "study_group": "control",
                "language": "english", "sms_name": "Test", "phone_number": "0700000004", "birthdate": "1990-02-05",
