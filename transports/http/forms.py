...
class ParticipantSendForm(ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['participant'] = SpecialModelChoiceField(queryset=Participant.objects.filter(study_group='two-way'))
...
class SystemSendForm(ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['participant'] = SpecialModelChoiceField(queryset=Participant.objects.all())
