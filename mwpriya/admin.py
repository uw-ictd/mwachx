...
class AutomatedMessageHIVAdmin(AutomatedMessageAdmin):
    smsbank_check_template = "admin/mwpriya/automatedmessagehiv/sms_bank_check.html"
    smsbank_import_template = "admin/mwpriya/automatedmessagehiv/sms_bank_import.html"
